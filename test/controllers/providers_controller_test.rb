...
class ProvidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create provider" do
    assert_difference('Provider.count') do
      post providers_url, params: { provider: { address_id: @provider.address_id, name: @provider.name } }
    end
  ...
  test "should update provider" do
    patch provider_url(@provider), params: { provider: { address_id: @provider.address_id, name: @provider.name } }
